    ...
    <div class="setting-group">
      ...
      <el-form :model="model.storage" label-width="160px" size="small">
        ...
        <el-form-item label="数据迁移">
          <el-button type="primary" @click="migrateData" icon="Switch">迁移旧版本数据</el-button>
...
import { Search, FolderOpened, Switch, Delete, Refresh, Download, Document, ChatDotRound } from '@element-plus/icons-vue';
