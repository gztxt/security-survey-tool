          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template #default="scope">
              <div class="action-buttons">
                ...
                <template v-else>
                  <el-button size="small" type="primary" link @click="confirmEditing(scope.row)">确定</el-button>
                  <el-button size="small" link @click="cancelEditing">取消</el-button>
                </template>
...
import { CircleCheck, Search, Refresh, Download, Upload, Plus, Delete } from '@element-plus/icons-vue';
...
function startEditing(shortcut: any) {
  ...
  nextTick(() => {
    const el = document.querySelector(`.key-display.editing`) as HTMLElement | null;
    el?.focus();
  });
}
