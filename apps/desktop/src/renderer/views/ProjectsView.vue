  ...
  <div class="projects-view">
    ...
    <div class="view-toolbar" style="margin-bottom: 16px">
      <el-radio-group v-model="viewMode" size="small" button-style="solid">
        <el-radio-button label="grid" :label="GridIcon" title="网格视图" />
        <el-radio-button label="list" :label="ListIcon" title="列表视图" />
        <el-radio-button label="table" :label="TableIcon" title="表格视图" />
      </el-radio-group>
            ...
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <el-dropdown-item divided @click.stop="archiveProject(project.id)"><el-icon><Archive /></el-icon> 归档</el-dropdown-item>
...
import {
  Refresh, Plus, Search, More, Edit, CopyDocument, Download, Archive, Delete,
  FolderOpened, Monitor, Link, Grid, List, Table, Clock, Calendar
...
const GridIcon = { template: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect></svg>' };
const ListIcon = { template: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>' };
const TableIcon = { template: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3h18v18H3z"></path><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="3"></line></svg>' };
