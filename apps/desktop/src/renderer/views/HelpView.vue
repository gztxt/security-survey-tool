...
import {
  ...
  VideoPlay, Keyboard, HelpFilled, Printer, Download, CopyDocument
} from '@element-plus/icons-vue';
import { Document, FolderOpened, Picture, Setting, Upload, Download, Refresh, Search, ArrowDown, Link, Platform, ChatDotRound, VideoPlay, Keyboard, HelpFilled, Printer, Download, CopyDocument } from '@element-plus/icons-vue';
