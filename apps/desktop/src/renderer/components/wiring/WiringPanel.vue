...
// 计算属性
const wells = computed(() => projectStore.projectWells.value);
const trays = computed(() => projectStore.projectTrays.value);
const cables = computed(() => projectStore.projectCables.value);
const devices = computed(() => projectStore.projectDevices.value);
